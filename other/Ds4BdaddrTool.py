...
def main(argv):
    ...
    if mac != None and mac != False and mac != 0:
        ...
        # unsure about the byte ordering of the MAC, TODO: double check
        msg = [0x13, mac.words[5], mac.words[4], mac.words[3], mac.words[2], mac.words[1], mac.words[0], 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
