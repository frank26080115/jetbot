...
static volatile uint8_t twi_lastSlaveAddr;
 ...
 * Desc     sets slave address mask
 * Input    none
 * Output   none
 */
void twi_setAddressMask(uint8_t mask)
{
  TWAMR = mask << 1;
}
...
SIGNAL(TWI_vect)
{
  switch(TW_STATUS){
    ...
    case TW_SR_ARB_LOST_GCALL_ACK: // lost arbitration, returned ack
      ...
      twi_state = TWI_SRX;
      // remember the slave address used
      twi_lastSlaveAddr = TWDR;
    ...
    case TW_SR_STOP: // stop or repeated start condition received
      ...
      twi_onSlaveReceive(twi_lastSlaveAddr, twi_rxBuffer, twi_rxBufferIndex);
    ...
    case TW_ST_ARB_LOST_SLA_ACK: // arbitration lost, returned ack
      ...
      twi_onSlaveTransmit(twi_lastSlaveAddr);
